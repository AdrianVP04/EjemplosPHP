...
//No es necesario inicializar variables en PHP, sin embargo, es muy buena práctica. Las variables no inicializadas tienen un valor predeterminado de acuerdo a su tipo dependiendo del contexto en el que son usadas. 
//Las booleanas se asumen como false, los enteros y flotantes como cero, las cadenas (p.ej. usadas en echo) se establecen como una cadena vacia, y los arrays se establecen como un array vacío.
...
echo "El valor de a con post-incremento es: $resultado <br>";
...
//Asignacion con operadores______________________________________-
$a = 20;
$a += 10;//$a = $a + 10;
